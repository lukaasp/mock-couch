...
module.exports = function (self) {
  ...
  return function (req, res, next) {
    ...
    db = formatDB(self.databases[req.params.db]);Object.prototype.hasOwnProperty.call(req.query, 'reduce')

    view = self.databases[req.params.db]['_design/' + req.params.doc].views[req.params.name];
    // Create flags
    useReduce     = (view.hasOwnProperty('reduce') && (!Object.prototype.hasOwnProperty.call(req.query, 'reduce') || req.query.reduce !== 'false'));
    useGroup      = (Object.prototype.hasOwnProperty.call(req.query, 'group') && req.query.group === 'true');
    includeDocs   = (Object.prototype.hasOwnProperty.call(req.query, 'include_docs') && req.query.include_docs === 'true');
    skip          = (Object.prototype.hasOwnProperty.call(req.query, 'skip') && parseInt(req.query.skip, 10)) || 0;
    ...
    if (!view.hasOwnProperty('reduce') && Object.prototype.hasOwnProperty.call(req.query, 'reduce') && req.query.reduce === 'true') {
      res.send(400, {
