...
module.exports = function (self) {
  ...
  return function (req, res, next) {
    var dbname, db, seq, heartbeat, stringify;Object.prototype.hasOwnProperty.call(req.query, 'heartbeat')

    dbname = req.params.db;
    db = self.databases[dbname];
    stringify = R.rPartial(JSON.stringify.bind(JSON), null, '');
    heartbeat = Object.prototype.hasOwnProperty.call(req.query, 'heartbeat') ?
