...
module.exports = function (req, res, rows, isAllDocs) {
  var skip    = (Object.prototype.hasOwnProperty.call(req.query, 'skip') && parseInt(req.query.skip, 10)) || 0,
    limit     = (Object.prototype.hasOwnProperty.call(req.query, 'limit') && parseInt(req.query.limit, 10)) || false,
    ...
    useDescending = (Object.prototype.hasOwnProperty.call(req.query, 'descending') && req.query.descending === 'true'),
    tempkey;
